...
import unittest
from test.test_inference  import TestInference
from test.test_covariance import TestCovariance
from test.test_mean       import TestMean
from test.test_likelihood import TestLikelihood
